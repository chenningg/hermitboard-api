...
func AuthTypeEQ(v AuthType) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func AuthTypeNEQ(v AuthType) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func AuthTypeIn(vs ...AuthType) predicate.Account {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AuthTypeNotIn(vs ...AuthType) predicate.Account {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
