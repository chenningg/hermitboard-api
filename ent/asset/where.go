...
func ID(id ulid.ULID) predicate.Asset {
...
func IDEQ(id ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
...
func IDIn(ids ...ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
...
func IDNotIn(ids ...ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
...
func IDGTE(id ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
...
func IDLT(id ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
...
func IDLTE(id ulid.ULID) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
...
func HasTransactionBase() predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, TransactionBaseTable, TransactionBasePrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasTransactionQuote() predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, TransactionQuoteTable, TransactionQuotePrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
// HasDailyAssetPrice applies the HasEdge predicate on the "daily_asset_price" edge.
func HasDailyAssetPrice() predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DailyAssetPriceTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, DailyAssetPriceTable, DailyAssetPriceColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasDailyAssetPriceWith applies the HasEdge predicate on the "daily_asset_price" edge with a given conditions (other predicates).
func HasDailyAssetPriceWith(preds ...predicate.DailyAssetPrice) predicate.Asset {
	return predicate.Asset(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DailyAssetPriceInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, DailyAssetPriceTable, DailyAssetPriceColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
