...
func ID(id ulid.ULID) predicate.AssetClass {
...
func IDEQ(id ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func IDIn(ids ...ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func IDNotIn(ids ...ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func IDGTE(id ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func IDLT(id ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func IDLTE(id ulid.ULID) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func ClassEQ(v hbtype.AssetClass) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func ClassNEQ(v hbtype.AssetClass) predicate.AssetClass {
	return predicate.AssetClass(func(s *sql.Selector) {
...
func ClassIn(vs ...hbtype.AssetClass) predicate.AssetClass {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ClassNotIn(vs ...hbtype.AssetClass) predicate.AssetClass {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
