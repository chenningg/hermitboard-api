...
func (acc *AssetClassCreate) SetClass(hc hbtype.AssetClass) *AssetClassCreate {
	acc.mutation.SetClass(hc)
	return acc
}
...
func (acc *AssetClassCreate) SetID(u ulid.ULID) *AssetClassCreate {
	acc.mutation.SetID(u)
	return acc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (acc *AssetClassCreate) SetNillableID(u *ulid.ULID) *AssetClassCreate {
	if u != nil {
		acc.SetID(*u)
	}
	return acc
...
func (acc *AssetClassCreate) AddAssetIDs(ids ...ulid.ULID) *AssetClassCreate {
...
func (acc *AssetClassCreate) check() error {
	...
	if _, ok := acc.mutation.Class(); !ok {
		return &ValidationError{Name: "class", err: errors.New(`ent: missing required field "AssetClass.class"`)}
	}
	if v, ok := acc.mutation.Class(); ok {
...
func (acc *AssetClassCreate) createSpec() (*AssetClass, *sqlgraph.CreateSpec) {
	...
	if value, ok := acc.mutation.Class(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeEnum,
			Value:  value,
