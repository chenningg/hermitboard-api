...
func (acq *AssetClassQuery) FirstID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (acq *AssetClassQuery) FirstIDX(ctx context.Context) ulid.ULID {
...
func (acq *AssetClassQuery) OnlyID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (acq *AssetClassQuery) OnlyIDX(ctx context.Context) ulid.ULID {
...
func (acq *AssetClassQuery) IDs(ctx context.Context) ([]ulid.ULID, error) {
	var ids []ulid.ULID
...
func (acq *AssetClassQuery) IDsX(ctx context.Context) []ulid.ULID {
	ids, err := acq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (acq *AssetClassQuery) loadAssets(ctx context.Context, query *AssetQuery, nodes []*AssetClass, init func(*AssetClass), assign func(*AssetClass, *Asset)) error {
	...
	nodeids := make(map[ulid.ULID]*AssetClass)
	for i := range nodes {
...
func (acgb *AssetClassGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (acgb *AssetClassGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (acs *AssetClassSelect) Scan(ctx context.Context, v interface{}) error {
...
func (acs *AssetClassSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
