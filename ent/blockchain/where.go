...
func ID(id ulid.ULID) predicate.Blockchain {
...
func IDEQ(id ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
...
func IDIn(ids ...ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
...
func IDNotIn(ids ...ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
...
func IDGTE(id ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
...
func IDLT(id ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
...
func IDLTE(id ulid.ULID) predicate.Blockchain {
	return predicate.Blockchain(func(s *sql.Selector) {
