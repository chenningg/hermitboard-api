...
func (bc *BlockchainCreate) SetID(u ulid.ULID) *BlockchainCreate {
	bc.mutation.SetID(u)
	return bc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (bc *BlockchainCreate) SetNillableID(u *ulid.ULID) *BlockchainCreate {
	if u != nil {
		bc.SetID(*u)
	}
	return bc
...
func (bc *BlockchainCreate) AddCryptocurrencyIDs(ids ...ulid.ULID) *BlockchainCreate {
