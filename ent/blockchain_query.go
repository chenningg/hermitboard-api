...
func (bq *BlockchainQuery) FirstID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (bq *BlockchainQuery) FirstIDX(ctx context.Context) ulid.ULID {
...
func (bq *BlockchainQuery) OnlyID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (bq *BlockchainQuery) OnlyIDX(ctx context.Context) ulid.ULID {
...
func (bq *BlockchainQuery) IDs(ctx context.Context) ([]ulid.ULID, error) {
	var ids []ulid.ULID
...
func (bq *BlockchainQuery) IDsX(ctx context.Context) []ulid.ULID {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BlockchainQuery) loadCryptocurrencies(ctx context.Context, query *CryptocurrencyQuery, nodes []*Blockchain, init func(*Blockchain), assign func(*Blockchain, *Cryptocurrency)) error {
	...
	byID := make(map[ulid.ULID]*Blockchain)
	nids := make(map[ulid.ULID]map[*Blockchain]struct{})
...
func (bgb *BlockchainGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (bgb *BlockchainGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (bs *BlockchainSelect) Scan(ctx context.Context, v interface{}) error {
...
func (bs *BlockchainSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
