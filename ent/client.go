...
// UpdateOneID returns an update builder for the given id.
func (c *AssetClient) UpdateOneID(id ulid.ULID) *AssetUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *AssetClient) DeleteOneID(id ulid.ULID) *AssetDeleteOne {
...
func (c *AssetClient) Get(ctx context.Context, id ulid.ULID) (*Asset, error) {
	return c.Query().Where(asset.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AssetClient) GetX(ctx context.Context, id ulid.ULID) *Asset {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryTransactionBase queries the transaction_base edge of a Asset.
func (c *AssetClient) QueryTransactionBase(a *Asset) *TransactionQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, asset.TransactionBaseTable, asset.TransactionBasePrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(a.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryTransactionQuote queries the transaction_quote edge of a Asset.
func (c *AssetClient) QueryTransactionQuote(a *Asset) *TransactionQuery {
	query := &TransactionQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := a.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(asset.Table, asset.FieldID, id),
			sqlgraph.To(transaction.Table, transaction.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, asset.TransactionQuoteTable, asset.TransactionQuotePrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(a.driver.Dialect(), step)
		return fromV, nil
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *AssetClassClient) UpdateOneID(id ulid.ULID) *AssetClassUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *AssetClassClient) DeleteOneID(id ulid.ULID) *AssetClassDeleteOne {
...
func (c *AssetClassClient) Get(ctx context.Context, id ulid.ULID) (*AssetClass, error) {
	return c.Query().Where(assetclass.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AssetClassClient) GetX(ctx context.Context, id ulid.ULID) *AssetClass {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *BlockchainClient) UpdateOneID(id ulid.ULID) *BlockchainUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *BlockchainClient) DeleteOneID(id ulid.ULID) *BlockchainDeleteOne {
...
func (c *BlockchainClient) Get(ctx context.Context, id ulid.ULID) (*Blockchain, error) {
	return c.Query().Where(blockchain.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *BlockchainClient) GetX(ctx context.Context, id ulid.ULID) *Blockchain {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *CryptocurrencyClient) UpdateOneID(id ulid.ULID) *CryptocurrencyUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *CryptocurrencyClient) DeleteOneID(id ulid.ULID) *CryptocurrencyDeleteOne {
...
func (c *CryptocurrencyClient) Get(ctx context.Context, id ulid.ULID) (*Cryptocurrency, error) {
	return c.Query().Where(cryptocurrency.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *CryptocurrencyClient) GetX(ctx context.Context, id ulid.ULID) *Cryptocurrency {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *DailyAssetPriceClient) UpdateOneID(id ulid.ULID) *DailyAssetPriceUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *DailyAssetPriceClient) DeleteOneID(id ulid.ULID) *DailyAssetPriceDeleteOne {
...
func (c *DailyAssetPriceClient) Get(ctx context.Context, id ulid.ULID) (*DailyAssetPrice, error) {
	return c.Query().Where(dailyassetprice.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *DailyAssetPriceClient) GetX(ctx context.Context, id ulid.ULID) *DailyAssetPrice {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *ExchangeClient) UpdateOneID(id ulid.ULID) *ExchangeUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *ExchangeClient) DeleteOneID(id ulid.ULID) *ExchangeDeleteOne {
...
func (c *ExchangeClient) Get(ctx context.Context, id ulid.ULID) (*Exchange, error) {
	return c.Query().Where(exchange.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ExchangeClient) GetX(ctx context.Context, id ulid.ULID) *Exchange {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *ExchangeClient) QueryTransactions(e *Exchange) *TransactionQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(transaction.Table, transaction.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, exchange.TransactionsTable, exchange.TransactionsColumn),
		)
...
// UpdateOneID returns an update builder for the given id.
func (c *PortfolioClient) UpdateOneID(id ulid.ULID) *PortfolioUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *PortfolioClient) DeleteOneID(id ulid.ULID) *PortfolioDeleteOne {
...
func (c *PortfolioClient) Get(ctx context.Context, id ulid.ULID) (*Portfolio, error) {
	return c.Query().Where(portfolio.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PortfolioClient) GetX(ctx context.Context, id ulid.ULID) *Portfolio {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *TransactionClient) UpdateOneID(id ulid.ULID) *TransactionUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *TransactionClient) DeleteOneID(id ulid.ULID) *TransactionDeleteOne {
...
func (c *TransactionClient) Get(ctx context.Context, id ulid.ULID) (*Transaction, error) {
	return c.Query().Where(transaction.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TransactionClient) GetX(ctx context.Context, id ulid.ULID) *Transaction {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *TransactionClient) QueryBaseAsset(t *Transaction) *AssetQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(transaction.Table, transaction.FieldID, id),
			sqlgraph.To(asset.Table, asset.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, transaction.BaseAssetTable, transaction.BaseAssetPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(t.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *TransactionClient) QueryQuoteAsset(t *Transaction) *AssetQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(transaction.Table, transaction.FieldID, id),
			sqlgraph.To(asset.Table, asset.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, transaction.QuoteAssetTable, transaction.QuoteAssetPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(t.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *TransactionClient) QueryExchange(t *Transaction) *ExchangeQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, false, transaction.ExchangeTable, transaction.ExchangeColumn),
		)
		fromV = sqlgraph.Neighbors(t.driver.Dialect(), step)
		return fromV, nil
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *TransactionTypeClient) UpdateOneID(id ulid.ULID) *TransactionTypeUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *TransactionTypeClient) DeleteOneID(id ulid.ULID) *TransactionTypeDeleteOne {
...
func (c *TransactionTypeClient) Get(ctx context.Context, id ulid.ULID) (*TransactionType, error) {
	return c.Query().Where(transactiontype.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TransactionTypeClient) GetX(ctx context.Context, id ulid.ULID) *TransactionType {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
