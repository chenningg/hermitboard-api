...
func (cc *CryptocurrencyCreate) SetID(u ulid.ULID) *CryptocurrencyCreate {
	cc.mutation.SetID(u)
	return cc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (cc *CryptocurrencyCreate) SetNillableID(u *ulid.ULID) *CryptocurrencyCreate {
	if u != nil {
		cc.SetID(*u)
	}
	return cc
...
func (cc *CryptocurrencyCreate) SetAssetID(id ulid.ULID) *CryptocurrencyCreate {
...
func (cc *CryptocurrencyCreate) AddBlockchainIDs(ids ...ulid.ULID) *CryptocurrencyCreate {
