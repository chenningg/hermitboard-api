...
func (cu *CryptocurrencyUpdate) SetAssetID(id ulid.ULID) *CryptocurrencyUpdate {
...
func (cu *CryptocurrencyUpdate) AddBlockchainIDs(ids ...ulid.ULID) *CryptocurrencyUpdate {
...
func (cu *CryptocurrencyUpdate) RemoveBlockchainIDs(ids ...ulid.ULID) *CryptocurrencyUpdate {
...
// SetAssetID sets the "asset" edge to the Asset entity by ID.
func (cuo *CryptocurrencyUpdateOne) SetAssetID(id ulid.ULID) *CryptocurrencyUpdateOne {
...
// AddBlockchainIDs adds the "blockchains" edge to the Blockchain entity by IDs.
func (cuo *CryptocurrencyUpdateOne) AddBlockchainIDs(ids ...ulid.ULID) *CryptocurrencyUpdateOne {
...
// RemoveBlockchainIDs removes the "blockchains" edge to Blockchain entities by IDs.
func (cuo *CryptocurrencyUpdateOne) RemoveBlockchainIDs(ids ...ulid.ULID) *CryptocurrencyUpdateOne {
