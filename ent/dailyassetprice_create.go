...
func (dapc *DailyAssetPriceCreate) SetID(u ulid.ULID) *DailyAssetPriceCreate {
	dapc.mutation.SetID(u)
	return dapc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (dapc *DailyAssetPriceCreate) SetNillableID(u *ulid.ULID) *DailyAssetPriceCreate {
	if u != nil {
		dapc.SetID(*u)
	}
	return dapc
...
func (dapc *DailyAssetPriceCreate) SetBaseAssetID(id ulid.ULID) *DailyAssetPriceCreate {
	dapc.mutation.SetBaseAssetID(id)
	return dapc
}
...
func (dapc *DailyAssetPriceCreate) createSpec() (*DailyAssetPrice, *sqlgraph.CreateSpec) {
	...
	if nodes := dapc.mutation.BaseAssetIDs(); len(nodes) > 0 {
		...
		_node.asset_daily_asset_price = &nodes[0]
