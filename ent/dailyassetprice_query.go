...
func (dapq *DailyAssetPriceQuery) FirstID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (dapq *DailyAssetPriceQuery) FirstIDX(ctx context.Context) ulid.ULID {
...
func (dapq *DailyAssetPriceQuery) OnlyID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (dapq *DailyAssetPriceQuery) OnlyIDX(ctx context.Context) ulid.ULID {
...
func (dapq *DailyAssetPriceQuery) IDs(ctx context.Context) ([]ulid.ULID, error) {
	var ids []ulid.ULID
...
func (dapq *DailyAssetPriceQuery) IDsX(ctx context.Context) []ulid.ULID {
...
func (dapq *DailyAssetPriceQuery) loadBaseAsset(ctx context.Context, query *AssetQuery, nodes []*DailyAssetPrice, init func(*DailyAssetPrice), assign func(*DailyAssetPrice, *Asset)) error {
	...
	nodeids := make(map[ulid.ULID][]*DailyAssetPrice)
	for i := range nodes {
		if nodes[i].asset_daily_asset_price == nil {
			continue
		}
		fk := *nodes[i].asset_daily_asset_price
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "asset_daily_asset_price" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (dapgb *DailyAssetPriceGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (dapgb *DailyAssetPriceGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (daps *DailyAssetPriceSelect) Scan(ctx context.Context, v interface{}) error {
...
func (daps *DailyAssetPriceSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
