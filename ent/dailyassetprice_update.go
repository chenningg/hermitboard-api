...
func (dapu *DailyAssetPriceUpdate) SetBaseAssetID(id ulid.ULID) *DailyAssetPriceUpdate {
	dapu.mutation.SetBaseAssetID(id)
	return dapu
}
...
// SetBaseAssetID sets the "base_asset" edge to the Asset entity by ID.
func (dapuo *DailyAssetPriceUpdateOne) SetBaseAssetID(id ulid.ULID) *DailyAssetPriceUpdateOne {
	dapuo.mutation.SetBaseAssetID(id)
	return dapuo
}
