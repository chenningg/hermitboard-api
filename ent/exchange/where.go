...
func ID(id pulid.PULID) predicate.Exchange {
...
func IDEQ(id pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
...
func IDIn(ids ...pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
...
func IDGTE(id pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
...
func IDLT(id pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
...
func IDLTE(id pulid.PULID) predicate.Exchange {
	return predicate.Exchange(func(s *sql.Selector) {
