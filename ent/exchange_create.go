...
func (ec *ExchangeCreate) SetID(u ulid.ULID) *ExchangeCreate {
	ec.mutation.SetID(u)
	return ec
}

// SetNillableID sets the "id" field if the given value is not nil.
func (ec *ExchangeCreate) SetNillableID(u *ulid.ULID) *ExchangeCreate {
	if u != nil {
		ec.SetID(*u)
	}
	return ec
...
func (ec *ExchangeCreate) AddTransactionIDs(ids ...ulid.ULID) *ExchangeCreate {
