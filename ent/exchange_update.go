...
func (eu *ExchangeUpdate) AddTransactionIDs(ids ...ulid.ULID) *ExchangeUpdate {
...
func (eu *ExchangeUpdate) RemoveTransactionIDs(ids ...ulid.ULID) *ExchangeUpdate {
...
// AddTransactionIDs adds the "transactions" edge to the Transaction entity by IDs.
func (euo *ExchangeUpdateOne) AddTransactionIDs(ids ...ulid.ULID) *ExchangeUpdateOne {
...
// RemoveTransactionIDs removes the "transactions" edge to Transaction entities by IDs.
func (euo *ExchangeUpdateOne) RemoveTransactionIDs(ids ...ulid.ULID) *ExchangeUpdateOne {
