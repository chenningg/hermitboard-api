...
func (pc *PortfolioCreate) SetID(u ulid.ULID) *PortfolioCreate {
	pc.mutation.SetID(u)
	return pc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (pc *PortfolioCreate) SetNillableID(u *ulid.ULID) *PortfolioCreate {
	if u != nil {
		pc.SetID(*u)
	}
	return pc
...
func (pc *PortfolioCreate) SetAccountID(id ulid.ULID) *PortfolioCreate {
...
func (pc *PortfolioCreate) AddTransactionIDs(ids ...ulid.ULID) *PortfolioCreate {
