...
func (pq *PortfolioQuery) FirstID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (pq *PortfolioQuery) FirstIDX(ctx context.Context) ulid.ULID {
...
func (pq *PortfolioQuery) OnlyID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (pq *PortfolioQuery) OnlyIDX(ctx context.Context) ulid.ULID {
...
func (pq *PortfolioQuery) IDs(ctx context.Context) ([]ulid.ULID, error) {
	var ids []ulid.ULID
...
func (pq *PortfolioQuery) IDsX(ctx context.Context) []ulid.ULID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PortfolioQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Portfolio, init func(*Portfolio), assign func(*Portfolio, *Account)) error {
	...
	nodeids := make(map[ulid.ULID][]*Portfolio)
	for i := range nodes {
