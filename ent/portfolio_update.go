...
func (pu *PortfolioUpdate) SetAccountID(id ulid.ULID) *PortfolioUpdate {
...
func (pu *PortfolioUpdate) AddTransactionIDs(ids ...ulid.ULID) *PortfolioUpdate {
...
func (pu *PortfolioUpdate) RemoveTransactionIDs(ids ...ulid.ULID) *PortfolioUpdate {
...
// SetAccountID sets the "account" edge to the Account entity by ID.
func (puo *PortfolioUpdateOne) SetAccountID(id ulid.ULID) *PortfolioUpdateOne {
...
// AddTransactionIDs adds the "transactions" edge to the Transaction entity by IDs.
func (puo *PortfolioUpdateOne) AddTransactionIDs(ids ...ulid.ULID) *PortfolioUpdateOne {
...
// RemoveTransactionIDs removes the "transactions" edge to Transaction entities by IDs.
func (puo *PortfolioUpdateOne) RemoveTransactionIDs(ids ...ulid.ULID) *PortfolioUpdateOne {
