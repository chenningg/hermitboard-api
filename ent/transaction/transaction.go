...
const (
	...
	// BaseAssetTable is the table that holds the base_asset relation/edge. The primary key declared below.
	BaseAssetTable = "transaction_base_asset"
	// BaseAssetInverseTable is the table name for the Asset entity.
	// It exists in this package in order to avoid circular dependency with the "asset" package.
	BaseAssetInverseTable = "assets"
	// QuoteAssetTable is the table that holds the quote_asset relation/edge. The primary key declared below.
	QuoteAssetTable = "transaction_quote_asset"
	...
	ExchangeColumn = "transaction_exchange"
)
...
var (
	// BaseAssetPrimaryKey and BaseAssetColumn2 are the table columns denoting the
	// primary key for the base_asset relation (M2M).
	BaseAssetPrimaryKey = []string{"transaction_id", "asset_id"}
	// QuoteAssetPrimaryKey and QuoteAssetColumn2 are the table columns denoting the
	// primary key for the quote_asset relation (M2M).
	QuoteAssetPrimaryKey = []string{"transaction_id", "asset_id"}
)
