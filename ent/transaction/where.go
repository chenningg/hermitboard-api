...
func ID(id ulid.ULID) predicate.Transaction {
...
func IDEQ(id ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
...
func IDIn(ids ...ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
...
func IDNotIn(ids ...ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
...
func IDGTE(id ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
...
func IDLT(id ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
...
func IDLTE(id ulid.ULID) predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
...
func HasBaseAsset() predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, BaseAssetTable, BaseAssetPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasQuoteAsset() predicate.Transaction {
	return predicate.Transaction(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, QuoteAssetTable, QuoteAssetPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
