...
func (tq *TransactionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Transaction, error) {
	...
	if query := tq.withBaseAsset; query != nil {
		if err := tq.loadBaseAsset(ctx, query, nodes, nil,
			func(n *Transaction, e *Asset) { n.Edges.BaseAsset = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withQuoteAsset; query != nil {
		if err := tq.loadQuoteAsset(ctx, query, nodes, nil,
			func(n *Transaction, e *Asset) { n.Edges.QuoteAsset = e }); err != nil {
			return nil, err
		}
	}
