...
type TransactionType struct {
	...
	Type hbtype.TransactionType `json:"type,omitempty"`
...
func (*TransactionType) scanValues(columns []string) ([]interface{}, error) {
	values := make([]interface{}, len(columns))
	for i := range columns {
		switch columns[i] {
		case transactiontype.FieldType:
			values[i] = new(hbtype.TransactionType)
...
func (tt *TransactionType) assignValues(columns []string, values []interface{}) error {
	...
	for i := range columns {
		...
		case transactiontype.FieldType:
			if value, ok := values[i].(*hbtype.TransactionType); !ok {
