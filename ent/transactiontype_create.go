...
func (ttc *TransactionTypeCreate) SetType(ht hbtype.TransactionType) *TransactionTypeCreate {
	ttc.mutation.SetType(ht)
	return ttc
}
...
func (ttc *TransactionTypeCreate) SetID(u ulid.ULID) *TransactionTypeCreate {
	ttc.mutation.SetID(u)
	return ttc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (ttc *TransactionTypeCreate) SetNillableID(u *ulid.ULID) *TransactionTypeCreate {
	if u != nil {
		ttc.SetID(*u)
	}
	return ttc
...
func (ttc *TransactionTypeCreate) AddTransactionIDs(ids ...ulid.ULID) *TransactionTypeCreate {
...
func (ttc *TransactionTypeCreate) check() error {
	...
	if _, ok := ttc.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "TransactionType.type"`)}
	}
