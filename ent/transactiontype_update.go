...
func (ttu *TransactionTypeUpdate) SetType(ht hbtype.TransactionType) *TransactionTypeUpdate {
	ttu.mutation.SetType(ht)
	return ttu
}
...
func (ttu *TransactionTypeUpdate) AddTransactionIDs(ids ...ulid.ULID) *TransactionTypeUpdate {
...
func (ttu *TransactionTypeUpdate) RemoveTransactionIDs(ids ...ulid.ULID) *TransactionTypeUpdate {
...
func (ttu *TransactionTypeUpdate) check() error {
	if v, ok := ttu.mutation.GetType(); ok {
		if err := transactiontype.TypeValidator(v); err != nil {
			return &ValidationError{Name: "type", err: fmt.Errorf(`ent: validator failed for field "TransactionType.type": %w`, err)}
		}
	}
...
func (ttu *TransactionTypeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ttu.mutation.GetType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeEnum,
			Value:  value,
			Column: transactiontype.FieldType,
		})
	}
...
// SetType sets the "type" field.
func (ttuo *TransactionTypeUpdateOne) SetType(ht hbtype.TransactionType) *TransactionTypeUpdateOne {
	ttuo.mutation.SetType(ht)
	return ttuo
}
...
// AddTransactionIDs adds the "transactions" edge to the Transaction entity by IDs.
func (ttuo *TransactionTypeUpdateOne) AddTransactionIDs(ids ...ulid.ULID) *TransactionTypeUpdateOne {
...
// RemoveTransactionIDs removes the "transactions" edge to Transaction entities by IDs.
func (ttuo *TransactionTypeUpdateOne) RemoveTransactionIDs(ids ...ulid.ULID) *TransactionTypeUpdateOne {
